            ...
            <div class="row row-cols-2">
                <c:if test="${active.size() >= 2}">
                    <div class="col-md-6">
                        ...
                        <div class="text border">
                            <h5 class="title">
                                <a href="/pageContent/${active.get(1).idPost}"
                                   class="show-small"> ${active.get(1).title} </a>
                            </h5>
                            <!--Start:author-->
                            <a href="#"> <img
                ...
                <c:if test="${active.size() >= 3}">
                    <div class="col-md-6">
                        ...
                        <div class="text border">
                            <h5 class="title">
                                <a href="/pageContent/${active.get(2).idPost}"
                                   class="show-small">${active.get(2).title}</a>
                            </h5>
                            <!--Start:author-->
                            <a href="#"> <img
            ...
            <div class="row row-cols-2">
                <c:if test="${active.size() >= 4}">
                    <div class="col-md-6 mt-2">
                        ...
                        <div class="text border">
                            <h5 class="title">
                                <a href="/pageContent/${active.get(3).idPost}"
                                   class="show-small">${active.get(3).title}</a>
                            </h5>
                            <!--Start:author-->
                            <a href="#"> <img
                ...
                <c:if test="${active.size() >= 5}">
                    <div class="col-md-6 mt-2">
                        ...
                        <div class="text border">
                            <h5 class="title">
                                <a href="/pageContent/${active.get(4).idPost}"
                                   class="show-small">${active.get(4).title}</a>
                            </h5>
                            <!--Start:author-->
                            <a href="#"> <img
            ...
            <div class="row row-cols-2">
                <c:if test="${study.size() >= 2}">
                    <div class="col-md-6">
                        ...
                        <div class="text border">
                            <h5 class="title">
                                <a href="/pageContent/${study.get(1).idPost}"
                                   class="show-small">${study.get(1).title}</a>
                            </h5>
                            <!--Start:author-->
                            <a href="#"> <img
                ...
                <c:if test="${study.size() >= 3}">
                    <div class="col-md-6">
                        ...
                        <div class="text border">
                            <h5 class="title">
                                <a href="/pageContent/${study.get(2).idPost}"
                                   class="show-small">${study.get(2).title}</a>
                            </h5>
                            <!--Start:author-->
                            <a href="#"> <img
            ...
            <div class="row row-cols-2">
                <c:if test="${study.size() >= 4}">
                    <div class="col-md-6 mt-2">
                        ...
                        <div class="text border">
                            <h5 class="title ">
                                <a href="/pageContent/${study.get(3).idPost}"
                                   class="show-small">${study.get(3).title}</a>
                            </h5>
                            <!--Start:author-->
                            <a href="#"> <img
                ...
                <c:if test="${study.size() >= 5}">
                    <div class="col-md-6 mt-2">
                        ...
                        <div class="text border">
                            <h5 class="title">
                                <a href="/pageContent/${study.get(4).idPost}"
                                   class="show-small">${study.get(4).title}</a>
                            </h5>
                            <!--Start:author-->
                            <a href="#"> <img
                ...
                <div class="background" style="background-image: url('${talk.get(0).thumb}');">
                    <div class="text">
                        <div style="position: absolute; bottom: 40px; margin-top: 0">
                            <h5 class="title">
                                <a href="/pageContent/${talk.get(0).idPost}" style="color: aliceblue;"
                                   class="show-small">${talk.get(0).title}</a>
                            </h5>
                        </div>
                        ...
                        <div class="author">
                            <a href="#"> <img
                                    ...
                                    class="show-small">${talk.get(0).user.username}</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="background" style="background-image: url('${talk.get(1).thumb}');">
                    <div class="text">
                        <div style="position: absolute; bottom: 40px; margin-top: 0">
                            <h5 class="title">
                                <a href="/pageContent/${talk.get(1).idPost}" style="color: aliceblue;"
                                   class="show-small">${talk.get(1).title}</a>
                            </h5>
                        </div>
            ...
            <div class="col-md-3">
                <div class="background" style="background-image: url('${talk.get(2).thumb}');">
                    <div class="text">
                        <div style="position: absolute; bottom: 40px; margin-top: 0">
                            <h5 class="title">
                                <a href="/pageContent/${talk.get(2).idPost}" style="color: aliceblue;"
                                   class="show-small">${talk.get(2).title}</a>
                            </h5>
                        </div>
                ...
                <a href="#">
                    <div class="background" style="background-image: url('${talk.get(3).thumb}');">
                        <div class="text">
                            <div style="position: absolute; bottom: 40px; margin-top: 0">
                                <h5 class="title">
                                    <a href="/pageContent/${talk.get(3).idPost}" style="color: aliceblue;"
                                       class="show-small">${talk.get(3).title}</a>
                                </h5>
                            </div>
            ...
            <div class="row row-cols-2">
                <c:if test="${another.size() >= 2}">
                    <div class="col-md-6">
                        ...
                        <div class="text border">
                            <h5 class="title">
                                <a href="/pageContent/${another.get(1).idPost}"
                                   class="show-small">${another.get(1).title}</a>
                            </h5>
                            <!--Start:author-->
                            <a href="#"> <img
                ...
                <c:if test="${another.size() >= 3}">
                    <div class="col-md-6">
                        ...
                        <div class="text border">
                            <h5 class="title">
                                <a href="/pageContent/${another.get(2).idPost}"
                                   class="show-small">${another.get(2).title}</a>
                            </h5>
                            <!--Start:author-->
                            <a href="#"> <img
            ...
            <div class="row row-cols-2">
                <c:if test="${another.size() >= 4}">
                    <div class="col-md-6 mt-2">
                        ...
                        <div class="text border" style="">
                            <h5 class="title">
                                <a href="/pageContent/${another.get(3).idPost}"
                                   class="show-small">${another.get(3).title}</a>
                            </h5>
                            <!--Start:author-->
                            <a href="#"> <img
                ...
                <c:if test="${another.size() >= 5}">
                    <div class="col-md-6 mt-2">
                        ...
                        <div class="text border">
                            <h5 class="title">
                                <a href="/pageContent/${another.get(4).idPost}"
                                   class="show-small">${another.get(4).title}</a>
                            </h5>
                            <!--Start:author-->
                            <a href="#"> <img
